...
public class BoardActivity extends AppCompatActivity {
    ...
    ListView listView;
    Button addPostButton, keywordSearchButton;
    ...
    class GetBoard extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String server_url = "http://jyosun.dothome.co.kr/BoardList.php";
            URL url;
            try {
    ...
    class FindBoard extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                ArrayAdapter arrayAdapter = new ArrayAdapter<String>(BoardActivity.this, android.R.layout.simple_list_item_1, searchTitleList);
                listView.setAdapter(arrayAdapter);
                arrayAdapter.notifyDataSetChanged();
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                server_url = "http://jyosun.dothome.co.kr/FindBoardList.php?postTitle=" + URLEncoder.encode(keywordText.getText().toString(), "UTF-8");
