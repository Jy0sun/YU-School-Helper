...
public class Schedule {
    ...
    private String monday[] = new String[14]; // 13교시 존재
    private String tuesday[] = new String[14]; // 13교시 존재
    private String wednesday[] = new String[14]; // 13교시 존재
    private String thursday[] = new String[14]; // 13교시 존재
    private String friday[] = new String[14]; // 13교시 존재
    ...
    public void addSchedule(String scheduleText) {
        int temp;
        if((temp = scheduleText.indexOf("월")) > -1) { // 월이라는 단어가 포함한 경우
            temp += 2;
            int startPoint = temp;
            int endPoint = temp;
